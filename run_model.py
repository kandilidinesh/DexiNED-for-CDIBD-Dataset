# Modified for training the CDIBD dataset. (CDI's Boundary Detection Dataset)
# Modified by: Kandili Dinesh
# GitHub Profile: https://github.com/kandilidinesh
...
def config_model():
    ...
    parser = argparse.ArgumentParser(description='Basic details to run DexiNed')
    # dataset config
    parser.add_argument('--train_dataset', default='BIPED', choices=['BIPED','BSDS','CDIBD']) # Added CDID dataset as an choice
